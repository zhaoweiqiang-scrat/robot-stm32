...
#define VEL_PUBLISH_RATE 20 //hz
#define BAT_PUBLISH_RATE 0.2 //hz
#define TH_PUBLISH_RATE 1 //hz
#define ULTR_PUBLISH_RATE 5 //hz
#define IR_PUBLISH_RATE 20 //hz
#define ILLU_PUBLISH_RATE 15 //hz
#define COLL_PUBLISH_RATE 30
#define LIFTER_PUBLISH_RATE 40
#define ANGLE_PUBLISH_RATE 10
#define CHARGE_PUBLISH_RATE 10
...
#define COUNTS_PER_REV  68400 //30400 wheel encoder's no of ticks per rev(gear_ratio * pulse_per_rev)
#define WHEEL_DIAMETER  0.165 //wheel's diameter in meters

#define LR_WHEELS_DISTANCE  0.354 //0.4415 
#define FR_WHEELS_DISTANCE  0.354 //0.4415 
...
#define RIKI_SERIAL2_DMA_ADDR           (uint32_t)&USART2->DR
...
#define RIKI_SERIAL3_DMA_ADDR           (uint32_t)&USART3->DR
