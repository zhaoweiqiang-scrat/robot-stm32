...
void Mpu6050::send_value(int dev_addr, uint8_t value)
{
...
uint8_t Mpu6050::check_id(int dev_addr, uint8_t reg_addr)
{
	Wire.beginTransmission(dev_addr);
	Wire.write(reg_addr);
	Wire.endTransmission();
...
void Mpu6050::measure_gyroscope()
{
	uint8_t gyro_read = 0;
...
bool Mpu6050::check_accelerometer()
{
...
void Mpu6050::measure_acceleration()
{
	uint8_t acc_reads = 0;
...
bool Mpu6050::check_magnetometer()
{
...
void Mpu6050::measure_magnetometer()
{
	uint8_t mag_reads = 0;
